class Circle():
    ...
    - __init__(x, y, radius): Initializes a new Circle instance.
      Raises a TypeError if the radius, x-coordinate
        or y-coordinate is not numeric.
      Raises a ValueError if the radius is negative.

    - x: Read-only property for accessing the
         x-coordinate of the circle's center.
    - y: Read-only property for accessing the
